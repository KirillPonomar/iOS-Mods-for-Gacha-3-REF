...
//        resultView_MGRE.addShadow_MGRE(with: UIColor(red: 0.887, green: 0.887, blue: 0.887, alpha: 1))
    ...
    private func configureLayout_MGRE() {
        ...
        searchTextField_MGRE.font = UIFont(name: "SF Pro Display Regular", size: fontSize) ?? UIFont.systemFont(ofSize: fontSize)
        searchTextField_MGRE.textColor = .white
        bottomViewHeight_MGRE.constant = deviceType == .phone ? 58 : 97
        searchViewHeight_MGRE.constant = deviceType == .phone ? 45 : 62
        resultView_MGRE.layer.cornerRadius = 12
        resultView_MGRE.layer.masksToBounds = true
        searchView_MGRE.layer.cornerRadius = deviceType == .phone ? 12 : 20
    ...
    func configureTableView_MGRE() {
        ...
        resultTableView_MGRE.layer.cornerRadius = 12
    }
